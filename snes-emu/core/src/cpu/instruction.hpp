//====================================================================
// Opcode table, expanded four times (M and X each 8/16-bit) via
// macros defined in opcodes.cpp. Included from within
// Cpu65816::instruction(); this file must not be compiled directly.
//
// Ported from the higan/bsnes WDC65816 core (instruction.hpp).
//
